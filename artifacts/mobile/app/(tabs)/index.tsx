...
import RaftaarPassScreen from "@/screens/RaftaarPassScreen";
...
const RIDE_SCREENS = ["booking", "searching", "driver_assigned", "live_tracking", "payment", "payment_success", "profile", "dispute_report", "package_booking", "support", "raftaarPass"];
  ...
  const renderContent = () => {
    ...
    if (isInRideFlow) {
      switch (screen) {
        ...
        case "raftaarPass":     return <RaftaarPassScreen />;
      }
    }
