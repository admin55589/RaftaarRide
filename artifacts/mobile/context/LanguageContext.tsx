...
export const TRANSLATIONS = {
  ...
  en: {
    ...
    commission_info: "0% commission",
    your_share: "100% yours",
    ...
    commission_label: "0% Commission",
    withdrawable_balance: "Withdrawable Balance",
    commission_note: "0% commission — what the customer pays is all yours 🎉",
